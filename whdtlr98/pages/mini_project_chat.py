...
from langchain_common.mini_project import response_from_langchain
...
if prompt:
    ...
    if message:
        ...
        with st.chat_message(CHATBOT_ROLE.assistant.name):
            ...
            assistant_response = st.write_stream(response_from_langchain(prompt=prompt, message_history=st.session_state.messages))
